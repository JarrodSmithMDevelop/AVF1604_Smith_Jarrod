 ...
 * to send analytic data that can be viewed on the All_Things_Weather Dashboard.
 *
 * For information on getting started with All_Things_Weather Platform Services,
