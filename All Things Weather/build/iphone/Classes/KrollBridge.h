...
@interface All_Things_WeatherObject : KrollCoverageObject {
#else
@interface All_Things_WeatherObject : KrollObject {
#endif
@private
...
extern NSString * All_Things_Weather$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	All_Things_WeatherObject *_all_things_weather;
    KrollObject* console;
	BOOL shutdown;
