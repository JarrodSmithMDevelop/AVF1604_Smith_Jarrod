...
//@interface All_Things_WeatherObject : NSObject
//@end

@interface All_Things_WeatherObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[All_Things_WeatherObject class]])
		{
			for (NSString *key in [[(All_Things_WeatherObject*)o modules] allKeys])
			{
