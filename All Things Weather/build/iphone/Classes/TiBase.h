...
// in simulator we redefine to format for All_Things_Weather Developer console
...
{\
	NSString * exceptionName = [@"org.all_things_weather." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.all_things_weather";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAll_Things_WeatherNativeItemNone = -1, 
	UIAll_Things_WeatherNativeItemSpinner = -2,
	UIAll_Things_WeatherNativeItemProgressBar = -3,
	
	UIAll_Things_WeatherNativeItemSlider = -4,
	UIAll_Things_WeatherNativeItemSwitch = -5,
	UIAll_Things_WeatherNativeItemMultiButton = -6,
	UIAll_Things_WeatherNativeItemSegmented = -7,
	
	UIAll_Things_WeatherNativeItemTextView = -8,
	UIAll_Things_WeatherNativeItemTextField = -9,
	UIAll_Things_WeatherNativeItemSearchBar = -10,
	
	UIAll_Things_WeatherNativeItemPicker = -11,
	UIAll_Things_WeatherNativeItemDatePicker = -12,
	
	UIAll_Things_WeatherNativeItemInfoLight = -13,
	UIAll_Things_WeatherNativeItemInfoDark = -14,
	
	UIAll_Things_WeatherNativeItemDisclosure = -15,
	
	UIAll_Things_WeatherNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all All_Things_Weather instances of
