...
/**
 The base class for all All_Things_Weather modules
 */
...
/**
 All_Things_Weather Platform calls this method on startup.
 */
-(void)startup;

/**
 All_Things_Weather Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 All_Things_Weather Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 All_Things_Weather Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 All_Things_Weather Platform calls this method on resume.
 @param sender The sender of the event.
 */
