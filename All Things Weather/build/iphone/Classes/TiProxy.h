...
//Rare exceptions to indicate a bug in the _all_things_weather code (Eg, function that a subclass should have implemented)
...
/**
 The base class for All_Things_Weather proxies.
 */
