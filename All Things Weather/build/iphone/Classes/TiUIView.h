...
/**
 Base class for all All_Things_Weather views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the All_Things_Weather view hierarchy (such as wrapped iOS UIViews) was touched.
