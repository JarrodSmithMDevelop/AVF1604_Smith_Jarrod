...
//@interface memoriesObject : NSObject
//@end

@interface memoriesObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[memoriesObject class]])
		{
			for (NSString *key in [[(memoriesObject*)o modules] allKeys])
			{
