...
// in simulator we redefine to format for memories Developer console
...
{\
	NSString * exceptionName = [@"org.memories." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.memories";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UImemoriesNativeItemNone = -1, 
	UImemoriesNativeItemSpinner = -2,
	UImemoriesNativeItemProgressBar = -3,
	
	UImemoriesNativeItemSlider = -4,
	UImemoriesNativeItemSwitch = -5,
	UImemoriesNativeItemMultiButton = -6,
	UImemoriesNativeItemSegmented = -7,
	
	UImemoriesNativeItemTextView = -8,
	UImemoriesNativeItemTextField = -9,
	UImemoriesNativeItemSearchBar = -10,
	
	UImemoriesNativeItemPicker = -11,
	UImemoriesNativeItemDatePicker = -12,
	
	UImemoriesNativeItemInfoLight = -13,
	UImemoriesNativeItemInfoDark = -14,
	
	UImemoriesNativeItemDisclosure = -15,
	
	UImemoriesNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all memories instances of
